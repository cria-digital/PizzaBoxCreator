...
class PizzaBoxTextAgent:
    ...
    def build_image_prompt(self) -> str:
        ...
        panel_treatment_note = (
            "\n\n"
            "TRATAMENTO DO VERSO\n"
            "O cliente pediu a parte de tras/parte de baixo da caixa vazia. "
            "Concentre a linguagem visual no painel frontal principal e mantenha "
            "a regiao superior simples, limpa e sem elementos importantes. "
            "Essa area sera limpa deterministicamente pelo sistema antes da arte final."
            if self.edit_data.get("empty_back_panel")
            else ""
        )
