...
def template_panel(name: str, *, inset_safe_margin: bool = False) -> NormalizedBox:
    """Return a normalized panel area from the standard pizza-box template."""
    panel = PIZZA_BOX_STANDARD_01["panels"][name]
    bounds = panel["bounds"]
