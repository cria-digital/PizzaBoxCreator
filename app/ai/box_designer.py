...
class PizzaBoxTextAgent:
    ...
    def build_image_prompt(self) -> str:
        ...
        return (
            ...
            "- Agrupe o logotipo ou imagem principal enviada no lado esquerdo da arte, dentro do painel esquerdo da caixa.\n"
            "- O logo deve ficar inteiro no lado esquerdo, sem cruzar o vinco central, sem encostar em corte, dobra, serrilha ou borda.\n"
            "- Reserve o lado direito para informacoes complementares e elementos decorativos secundarios.\n"
