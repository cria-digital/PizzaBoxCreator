...
const paths: Record<IconName, ReactElement> = {
  ...
  sparkles: (
    <path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3ZM19 15l.9 2.4L22 18l-2.1.8L19 21l-.9-2.2L16 18l2.1-.6L19 15Z" />
  ),
  image: (
    <>
  ...
  coin: (
    <>
      ...
      <path d="M12 7v10M9.5 9.5c0-1 1-1.5 2.5-1.5s2.5.5 2.5 1.7c0 2.3-5 1.3-5 3.6 0 1.2 1 1.7 2.5 1.7s2.5-.5 2.5-1.5" />
    </>
  ),
  database: (
    <>
  ...
  palette: (
    <>
      <path d="M12 2a10 10 0 0 0 0 20c1.1 0 2-.9 2-2 0-.5-.2-.9-.5-1.3-.3-.3-.5-.8-.5-1.2 0-1.1.9-2 2-2h2.4A4.6 4.6 0 0 0 22 10.9C22 6 17.5 2 12 2Z" />
